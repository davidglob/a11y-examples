  ...
  (function (_React$Component) {
    ...
    function Modal() {
      ...
      _defineProperty(
        ...
        function (event) {
          if (
            (_this.dialogNode && _this.dialogNode.contains(event.target)) || // If the click is on the scrollbar we don't want to close the modal.
            event.pageX >
